...
import net.simplyrin.togglesneak.TSMod;
...
public class ToggleSneakMod
{
	...
	private static TSMod tsModInstance;
	...
	public void init(FMLInitializationEvent event)
	{
		...
		tsModInstance = new TSMod();
		tsModInstance.checkStatus();
		tsModInstance.registerConfig();
	}
	...
	public static TSMod getTSModInstance() {
		return tsModInstance;
	}
}